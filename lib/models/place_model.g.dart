...
_$PlaceSummaryImpl _$$PlaceSummaryImplFromJson(Map<String, dynamic> json) =>
    _$PlaceSummaryImpl(
      ...
      type: PlaceTypeCodec.fromJson(json['type']),
      types: json['types'] == null
          ? const <PlaceType>[]
          : PlaceTypeCodec.fromJsonList(json['types']),
...
Map<String, dynamic> _$$PlaceSummaryImplToJson(_$PlaceSummaryImpl instance) =>
    <String, dynamic>{
      'id': instance.id,
      'name': instance.name,
      'type': PlaceTypeCodec.toJson(instance.type),
      'types': PlaceTypeCodec.toJsonList(instance.types),

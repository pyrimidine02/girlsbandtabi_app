...
class TravelReviewDetailPage extends ConsumerStatefulWidget {
  const TravelReviewDetailPage({super.key, required this.reviewId});
              ...
              ListTile(
                ...
                onTap: () {
                  ...
                  ScaffoldMessenger.of(context).showSnackBar(
                    const SnackBar(content: Text('수정 기능은 현재 목업 상태입니다.')),
                  );
                },
              ),
              ListTile(
                ...
                onTap: () {
                  Navigator.pop(context);
                  ScaffoldMessenger.of(context).showSnackBar(
                    const SnackBar(content: Text('삭제 기능은 현재 목업 상태입니다.')),
                  );
                },
              ),
            ],
